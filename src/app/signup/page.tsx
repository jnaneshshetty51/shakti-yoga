                ...
                <form onSubmit={handleSignup} className="space-y-5 sm:space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="firstName" required className="w-full p-3 border border-gray-200 rounded focus:outline-none focus:border-primary transition-colors text-sm sm:text-base" placeholder="John" />
                        </div>
                        <div>
                            <label htmlFor="lastName" className="block text-sm font-bold text-text/70 mb-1 uppercase tracking-wider">Last Name</label>
                            <input type="text" id="lastName" required className="w-full p-3 border border-gray-200 rounded focus:outline-none focus:border-primary transition-colors text-sm sm:text-base" placeholder="Doe" />
                        </div>
                    </div>

                    <div>
                        <label htmlFor="email" className="block text-sm font-bold text-text/70 mb-1 uppercase tracking-wider">Email</label>
                        <input type="email" id="email" required className="w-full p-3 border border-gray-200 rounded focus:outline-none focus:border-primary transition-colors text-sm sm:text-base" placeholder="your@email.com" />
                    </div>

                    <div>
                        <label htmlFor="password" className="block text-sm font-bold text-text/70 mb-1 uppercase tracking-wider">Password</label>
                        <input type="password" id="password" required className="w-full p-3 border border-gray-200 rounded focus:outline-none focus:border-primary transition-colors text-sm sm:text-base" placeholder="••••••••" />
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="country" className="block text-sm font-bold text-text/70 mb-1 uppercase tracking-wider">Country</label>
                            <select id="country" className="w-full p-3 border border-gray-200 rounded focus:outline-none focus:border-primary transition-colors bg-white text-sm sm:text-base">
                                <option>India</option>
                                <option>USA</option>
                                <option>UK</option>
                                <option>UAE</option>
                        ...
                        <div>
                            ...
                            <select id="timezone" className="w-full p-3 border border-gray-200 rounded focus:outline-none focus:border-primary transition-colors bg-white text-sm sm:text-base">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" className="w-full p-3 border border-gray-200 rounded focus:outline-none focus:border-primary transition-colors text-sm sm:text-base" placeholder="+91 98765 43210" />
                    </div>

                    <button type="submit" className="w-full py-3.5 bg-secondary text-white font-bold uppercase tracking-widest text-sm rounded hover:bg-primary transition-colors shadow-md">
                        Sign Up
                    </button>
                </form>
