                ...
                <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        <tr>
                            ...
                            <td className="py-4 text-right font-medium whitespace-nowrap">{money(invoice.amount - invoice.tax, invoice.currency)}</td>
                        </tr>
                        {invoice.tax > 0 && (
                            <tr>
                                <td className="py-2 text-sm text-gray-500">GST</td>
                                <td className="py-2 text-right text-sm text-gray-500 whitespace-nowrap">{money(invoice.tax, invoice.currency)}</td>
                            </tr>
                        )}
                    </tbody>
