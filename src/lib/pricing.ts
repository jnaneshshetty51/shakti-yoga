...
export const PLANS = {
    trial: {
        ...
        extraSeats: 0,
        features: ['1 live Everyday group class', 'Full practice library', 'Community access'],
        rcProductId: '',
    },
    starter: {
        key: 'starter',
    ...
    therapy: {
        ...
        weeklyClassLimit: null,
        extraSeats: 0,
        features: ['20 personal 1:1 sessions / month', 'Everyday Yoga included', 'Health assessment + plan'],
    ...
    therapy_annual: {
        ...
        dbPlanType: 'YOGA_THERAPY',
        subscriptionStatus: 'ACTIVE',
        credits: 240, // 20 sessions/month across the annual term (with 2 months free)
        sessionsPerCycle: null,
        weeklyClassLimit: null,
        extraSeats: 0,
        features: ['Everything in Therapy', 'Two months free', '240 sessions a year'],
