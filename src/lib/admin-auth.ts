...
// getSession() already enforces tokenVersion-based revocation (and account
// deactivation) for every caller; admin/teacher routes just need the
// role/tier checks below.
