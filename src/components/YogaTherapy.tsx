        ...
        <section id="therapy" className="py-12 sm:py-20 px-4 sm:px-8 bg-background">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12">
                ...
                <div className="flex-1 w-full">
                    ...
                    <h2 className="font-serif text-3xl md:text-4xl text-primary mb-4 sm:mb-6">1:1 Yoga Therapy</h2>
                    <p className="font-sans text-text/80 leading-relaxed mb-6 text-sm sm:text-base">
